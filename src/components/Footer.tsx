...
export function Footer() {
  ...
  return (
    <footer className="border-t border-white/5 mt-10 md:mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-3 leading-relaxed max-w-xs">
              B.Tech AI & Data Science Graduate passionate about web development, data analytics, and building intelligent solutions.
            </p>
            <a 
              href="mailto:ajayaj004@gmail.com" 
          ...
          {/* Connect */}
          <div>
            <h4 className="text-foreground font-semibold mb-4 text-sm uppercase tracking-wider">Connect</h4>
            <div className="space-y-3">
              <a 
                href="https://github.com/Ajay-Debug12" 
                target="_blank" 
              ...
              <a 
                href="https://www.linkedin.com/in/ajay-a-r/" 
                target="_blank" 
                rel="noopener noreferrer" 
      ...
      <div className="border-t border-white/5 py-5">
        <div className="container mx-auto px-4 text-center">
          <p className="text-xs text-muted-foreground/60">
            &copy; {new Date().getFullYear()} Ajay A. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
